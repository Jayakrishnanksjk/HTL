...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // If you use Gmail: enable 2FA and use a 16-char App Password
        $mail->Username   = 'jayakrishnanashi@gmail.com';     // <- your Gmail address
        $mail->Password   = 'ijcb xhef ovcj rols';       // <- Gmail App Password (NOT your login)
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // 'tls' also fine
        $mail->Port       = 587;

        // --- From / To ---
        // From should be the SAME as Username (better deliverability)
